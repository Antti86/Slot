...
#ifndef GOD_GRAPHICS
extern template
void Graphics::DrawSprite<SpriteEffect::NoChroma>(Vei2 pos, RectI srcRect, const RectI& clip, const Surface& s, SpriteEffect::NoChroma effect);
extern template
void Graphics::DrawSprite<SpriteEffect::Chroma>(Vei2 pos, RectI srcRect, const RectI& clip, const Surface& s, SpriteEffect::Chroma effect);
extern template
void Graphics::DrawSprite<SpriteEffect::Substitute>(Vei2 pos, RectI srcRect, const RectI& clip, const Surface& s, SpriteEffect::Substitute effect);
#endif